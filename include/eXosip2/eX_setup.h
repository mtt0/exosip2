...
typedef struct eXosip_tls_ctx_s {
  ...
  unsigned long tls_flags;         /**< openssl additional flag (example: SSL_OP_NO_TLSv1, SSL_OP_NO_TLSv1_1) */
  unsigned long dtls_flags;        /**< openssl additional flag (example: SSL_OP_NO_DTLSv1) */
