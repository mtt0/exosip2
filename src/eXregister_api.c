...
static int _eXosip_register_add_contact(struct eXosip_t *excontext, eXosip_reg_t *jreg, osip_message_t *reg) {
  int i;
...
static int _eXosip_generating_register(struct eXosip_t *excontext, eXosip_reg_t *jreg, osip_message_t **reg, char *from, char *proxy, char *contact, int expires) {
  int i;
